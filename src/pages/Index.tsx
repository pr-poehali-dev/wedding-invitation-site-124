...
const FLOWER_BG = "https://cdn.poehali.dev/projects/0b80e863-c8b8-4410-9c81-4f8c6721ef95/files/ad2f5a52-fe3f-43a6-ac84-779bd32753d1.jpg";
...
export default function Index() {
  ...
  return (
    <div className="min-h-screen font-sans text-[#1a1a1a] relative">
